...
public class ApartmentHandler {
    ...
    public void onSubmitButtonHandler(ActionEvent e) throws IOException {
        ...
        int nBedrooms= Integer.parseInt(bedroomsTextField.getText());
        ...
        builder = new ApartmentBuilder(stName, ct, pCode, isRented, stNumber, rent, nBedrooms, nBathrooms, sqFootage, uNumber);
